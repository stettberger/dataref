...
\Macro{\drefrow*\{\meta{comma-separated list}\}\{\meta{template}\}}
 ...
 unstarred variant interprets the expanded result as a datapoint key and uses \cmd\dref to expand it; the optional
 parameter is passed through to every invocation of \cmd\dref.
 The starred variant does not wrap the result into \cmd\dref, and, therefore, is more flexible.
...
\end{codeexample}
 ...
 With the \textbf{usagereport} package option enabled, \cmd{\drefusagereport} generates a usagereport of all referenced
