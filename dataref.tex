...
With the \texttt{scale to auto} you can choose the scaled-to unit automatically. The algorithm tries every unit on the
scala and chooses the unit, where the numerical value after scaling is nearest to the \meta{optimum number}.
